      ...
      <div className="container mx-auto px-6">
            ...
            <Card key={index} className="hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-white">
              <CardContent className="p-8">
                <div className="text-center mb-6">
                  ...
                  <p className="text-purple-600 mb-1">{speaker.title}</p>
        ...
        <div className="text-center mt-12">
          ...
          <p className="text-sm text-gray-500">
            Want to speak at our event? <a href="#contact" className="text-purple-600 hover:text-purple-800">Get in touch with us</a>
          </p>
        </div>
      </div>
    </section>
